...
🔹 **LUMIRA – AI Exhibition Assistant**

QR → Voice Chatbot → RAG LLM → Vector DB
<br>A voice-enabled AI assistant for exhibitions that provides product information through voice commands after a QR scan.

🔗 [https://github.com/4aruu/Lumira](https://github.com/4aruu/Lumira)

<br>

🔹 **NutriSwap – Food Alternative Finder**

Computer Vision → Nutritional Analysis → Healthy Swaps
...
🔗 [https://nutriswap.aaronjacobsunil.me](https://nutriswap.aaronjacobsunil.me)

<br>

🔹 **InfoBot – Academic Assistant**

FastAPI → Chatbot → Automation
<br>AI-based academic helper designed to handle timetable generation, conflict detection, and student queries.

🔗 [https://github.com/4aruu/InfoBot](https://github.com/4aruu/InfoBot)

<br>

🔹 **TaskIT – Task Management System**

React → Workflow Optimization → Productivity
<br>A streamlined task management application designed to organize personal workflows and boost daily productivity.

🔗 [https://github.com/4aruu/TaskIT](https://github.com/4aruu/TaskIT)
